...
class disp(Toplevel):
    def __init__(self,idi,n,s,e,p,a):
        ...
        self.name1.configure(state="readonly")
        ...
        self.sir_name1.configure(state="readonly")
        ...
        self.emaill1.configure(state="readonly")
        ...
        self.phone1.configure(state="readonly")
        ...
        # btn/////////////////////
        self.btnicon2 = PhotoImage(file="pimgs\\close.png")
        self.add_people = Button(self.bottom, image=self.btnicon2, compound=LEFT, text="Close",
                                 font="centaur 11", bg="white", width=100, command=self.clos)
